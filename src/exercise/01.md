...
ensembles pour créer une interface complète.
...
Beaucoup de librairies utlise ce pattern ce qui permet une utilisation du type.
...
Tu va maintenant devoir implémenter
